...
This module contains tests for the core AI functionality without loading the entire application.
"""
...
# Mock the necessary modules before importing AIService
with patch.dict('sys.modules', {
    'PyQt6': MagicMock(),
    'phoenix.ui': MagicMock(),
    'phoenix.ui.widgets': MagicMock(),
    'phoenix.ui.widgets.ai_assistant': MagicMock(),
}):
